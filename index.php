...
<body>
	<div class="social">
		<ul>
			<li><a href="https://www.facebook.com/urban.stlyle.73" target="_blank" class="icon-facebook2"></a></li>
			<li><a href="https://www.instagram.com/urban_style503/?hl=es-la" target="_blank" class="icon-instagram"></a></li>
			<li><a href="mailto:urbanstlyle7@gmail.com" class="icon-google2"></a></li>
		</ul>
	</div>
	...
	<div class="menu">
		...
		?>
		<a href="admin/">Panel Admintradores</a>
		<a href="?p=creditos">Créditos</a>
		<!--
...
<form method="post" action="?p=carrito">
	...
	<div class="footer">
		Copyright JesusMelara &copy; <?=date("Y")?>
	</div>
